...
class CustumerRegister extends StatefulWidget {
  const CustumerRegister({Key? key}) : super(key: key);

  @override
  State<CustumerRegister> createState() => _CustumerRegisterState();
}

class _CustumerRegisterState extends State<CustumerRegister> {
  late String name;
  late String email;
    ...
    if (_formKey.currentState!.validate()) {
      if (_imageFile != null) {
        try {
          ...
          Navigator.pushReplacementNamed(context, '/custumer_login_screen');
